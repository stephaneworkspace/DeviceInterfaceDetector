...
//  Enum.swift
//
//  List of devices inspired from https://stackoverflow.com/questions/26028918/how-to-determine-the-current-iphone-device-model
//
//  Created by Stéphane Bressani on 23.02.2024.
//

import Foundation

public enum UILib: String {
    case uiKit              = "UIKit",
         appKit             = "AppKit",
